...
use Library\Bundle\AppBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LibraryAppBundle:User')->findAll();
     ...
     * @Method("POST")
     * @Template("LibraryAppBundle:User:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LibraryAppBundle:User')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LibraryAppBundle:User:edit.html.twig")
     */
